                ...
                <div className="col-lg-5 order-2 order-lg-1">
                    <div className="sigma_about style-21">
                        <div className="section-title">
                            <h3 className="title text-white">Why Should You Opt for Doc-Match?</h3>
                        </div>
                        <div className="sigma_about-content">
                            <p>Tailored healthcare app guiding immigrants to find local doctors based on their language and specialization. Your pathway to personalized and effective medical care.</p>
                            {/* Data */}
